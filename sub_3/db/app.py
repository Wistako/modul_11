...
class db:
    def __init__(self):
        self.transactions = db.transation_init(self)
        self.cc = pd.read_csv(r'sub_3\db\country_codes.csv',index_col=0)
        self.customers = pd.read_csv(r'sub_3\db\customers.csv',index_col=0)
        self.prod_info = pd.read_csv(r'sub_3\db\prod_cat_info.csv')
        
    def transation_init(self):
        transactions = pd.DataFrame()
        src = r'sub_3\db\transactions'
...
app.layout = html.Div([html.Div([dcc.Tabs(id='tabs',value='tab-3',children=[
